...
<div id="show-car" class="content scaffold-show" role="main">
    ...
    <ol class="property-list car">
        ...
        <g:if test="${carInstance?.color}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="color-label"><g:fieldValue bean="${carInstance}"
                                                                                         field="color"/></span>
    ...
    <g:form>
        <fieldset class="buttons">
            ...
            <g:link class="edit" action="edit" id="${carInstance?.id}"><g:message code="default.button.edit.label"
                                                                                  default="Edit"/></g:link>
